  ...
  describe "Interpreter" $ do
    it "handles Assert Jeq with immediate" $ do
      let r1 = Reg 1
          ...
          new_state = handleTrans initial_state trans
          new_interval = registers new_state Array.! 1
       in new_interval `shouldBe` Value (Interval (Val 42) (Val 42))
    ...
    it "handles Assert Jne with immediate" $ do
      let r1 = Reg 1
          ...
          new_state = handleTrans initial_state trans
          new_interval = registers new_state Array.! 1
       in new_interval `shouldBe` Bottom
    ...
    it "handles Assert Jgt with immediate" $ do
      let r1 = Reg 1
          ...
          new_state = handleTrans initial_state trans
          new_interval = registers new_state Array.! 1
       in new_interval `shouldBe` Value (Interval (Val 43) (Val 100))
    ...
    it "handles Assert Jge with immediate" $ do
      let r1 = Reg 1
          ...
          new_state = handleTrans initial_state trans
          new_interval = registers new_state Array.! 1
       in new_interval `shouldBe` Value (Interval (Val 42) (Val 100))
    ...
    it "handles Assert Jlt with immediate" $ do
      let r1 = Reg 1
          ...
          new_state = handleTrans initial_state trans
          new_interval = registers new_state Array.! 1
       in new_interval `shouldBe` Value (Interval (Val 0) (Val 41))
    ...
    it "handles Assert Jle with immediate" $ do
      let r1 = Reg 1
          ...
          new_state = handleTrans initial_state trans
          new_interval = registers new_state Array.! 1
       in new_interval `shouldBe` Value (Interval (Val 0) (Val 42))
